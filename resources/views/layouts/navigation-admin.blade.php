            ...
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.dashboard') }}">
                        ...
                        @else
                             <span class="text-xl font-semibold text-gray-800 dark:text-gray-200">{{ config('settings.app_name', 'Admin') }}</span>
                        @endif
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.settings.edit')" :active="request()->routeIs('admin.settings.*')">
                     ...
                     <x-nav-link :href="route('converter.index')" :active="request()->routeIs('converter.index')">
                        {{ __('Lihat Situs') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
             ...
             <x-responsive-nav-link :href="route('converter.index')" :active="request()->routeIs('converter.index')">
                {{ __('Lihat Situs') }}
            </x-responsive-nav-link>
        </div>
